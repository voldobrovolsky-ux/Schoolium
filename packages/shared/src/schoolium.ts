...
export const ACCESS_PARAMS = {
  ...
  loginCodeDigits: 6,
  /**
   * Одноразовая ссылка входа — bootstrap первого модератора (AR-93), учётки
   * `provision` и ссылка с карточки сотрудника из кабинета администратора
   * (AR-189). 48 часов — решение владельца 2026-09-02 (прежде 24).
   */
...
/** Одноразовая ссылка входа с карточки сотрудника (AR-189): 48 часов. */
