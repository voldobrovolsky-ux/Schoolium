...
> **Легаси-пересмотр 2026-08-30:** решение ниже вытеснено — идентичность
> пользователя решается собственным контуром продукта, без внешнего IdP
> (AR-46 → AR-94 → **AR-154**: юзернейм и пароль, учётку заводит модератор).
> См. `docs/TENANCY.md` и `docs/ar/truth.md`. Ниже — принятое на момент
> 2026-06 решение, сохранено как есть.
