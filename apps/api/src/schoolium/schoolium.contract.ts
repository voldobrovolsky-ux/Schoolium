...
export const SCHOOL_EVENTS = {
  ...
  // 1.6.0 — разрешения правит администратор школы (AR-214). Событие одно на
...
/**
 * Правка разрешений администратором школы (AR-214). `scope: 'role'` — общие
