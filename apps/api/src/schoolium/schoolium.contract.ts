...
export const SCHOOL_EVENTS = {
  ...
  // 1.6.0 — разрешения правит администратор школы (AR-213). Событие одно на
...
/**
 * Правка разрешений администратором школы (AR-213). `scope: 'role'` — общие
