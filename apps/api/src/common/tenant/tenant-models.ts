...
export const TENANT_COLUMN: Record<string, string> = {
  ...
  // ─── Schoolium 1.3.0: реестры кабинета администратора (AR-186, AR-188) ───
  SchoolNetwork: 'workspaceId',
  SchoolAsset: 'workspaceId',
  SchoolAccessPolicy: 'workspaceId',
  // ─── Schoolium 1.6.0: школьные отклонения от пакетов прав (AR-213) ───
  SchoolPermissionOverride: 'workspaceId',
