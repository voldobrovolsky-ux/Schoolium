...
lines.push('  /* control (1.4.0, AR-198): одна высота у кнопок и полей на раскладку */');
push('ctl-h', `${t.control.height}px`);
push('ctl-h-mobile', `${t.control.heightMobile}px`);
push('ctl-h-sm', `${t.control.heightSm}px`);
lines.push('  /* radius */');
