...
export const reversals = [
  ...
  ['удалить профиль сотрудника',   '', 'необратимо по построению (AR-213): профиль стирается физически — учётка, креды, членство, сессии, токены входа и карточка; записи школы (отметки, уроки, колонки журнала, аудит) остаются историческими ссылками. Обратимая операция на той же карточке другая — отзыв активации'],
...
// Две разрушающие операции над сотрудником (AR-213, вытесняет правило подмены
